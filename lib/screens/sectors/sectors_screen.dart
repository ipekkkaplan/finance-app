...
import 'package:finance_app/screens/sectors/company_detail_screen.dart'; // screens/sectors/sectors_screen.dart
...
class _SectorsScreenState extends State<SectorsScreen> {
  ...
  final Color orange = const Color(0xFFFFAB00);

  // BU ALANDAKİ VERİLERİN SÜÜTUNU DAHA PROFESYONEL OLACAK ŞEKİLDE DÜZELTİLEMLİ BU BİR TASLAK
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          ...sectorsData.map((sector) => _buildSectorCard(sector)).toList(),
                ...
                const Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8),
                      Text(
                        "Teknoloji ve Havacılık sektörleri güçlü momentum gösteriyor. Kurumsal alımlar bu sektörlerde yoğunlaşmış durumda. Bankacılık sektörü ise konsolidasyon döneminde.",
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          SizedBox(height: 180, child: child), // Grafik alanı
